...
def execute_training(
    ...
    with ExitStack() as stack:
        ...
        trainer.train(resume_from_checkpoint=resume_from_checkpoint) # error
...
def train(
    ...
    print(trainer, model, peft_config, processor, dataset_meta)
    # trainer, model, fuck, None, None, Dataset
    # exit(0)
    execute_training(cfg, trainer, resume_from_checkpoint) # error 
