...
class HFCausalTrainerBuilder(TrainerBuilderBase):
    ...
    def build(self, total_num_steps):
        ...
        if self.cfg.eagle3 is not None:
            training_arguments_kwargs.update({"eval_strategy": self.cfg.eagle3.eval_strategy})
        ...
        if self.cfg.eagle3 is not None:
            data_collator_kwargs = {"online": self.cfg.eagle3.online}
        ...
        if self.cfg.eagle3 is not None:
            trainer_kwargs["bench_data_collator"] = eval_data_collator
        elif not (self.cfg.reward_model or self.cfg.process_reward_model):
        ...
        trainer = trainer_cls( # AxolotlTrainer
            model=self.model,
        ...
        return trainer # everythin is ok 
    ...
    def build_collator(
        ...
        **kwargs,
        ...
        if self.cfg.eagle3 is not None:
            return Eagle3DataCollatorWithPadding(online=kwargs["online"])
