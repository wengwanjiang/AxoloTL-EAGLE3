...
def do_train(cfg: DictDefault, cli_args: TrainerCliArgs):
    ...
    if cfg.eagle3 is not None:
        ...
        from axolotl.integrations.eagle3.data import generate_vocab_mapping_file
        
        generate_vocab_mapping_file(dataset_meta.train_dataset, target_vocab_size=cfg.eagle3.vocab_size, draft_vocab_size=cfg.eagle3.draft_vocab_size,\
                                                         cache_dir=cfg.eagle3.cache_dir, cache_key='vocab_mapping')
